// For the body background of the page
...
// Styles for the body of the calculator container
const calcBodyClass =
    "max-w-lg rounded overflow-hidden shadow-2xl bg-indigo-700 bg-gradient-to-tr from-gray-800 flex";
const calcBody = document.getElementsByClassName("calcBody")[0];
...
const previousNumber = document.getElementsByClassName("previousNumber")[0];
...
const currentNumber = document.getElementsByClassName("currentNumber")[0];
...
function addClasses(button){
    ...
    const baseClass = "number flex w-12 h-12 justify-center items-center m-1 font-bold py-2 px-2 hover:border-transparent rounded text-white border"
